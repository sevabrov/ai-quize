 ...
 */
export function Robot({ pose = 'wave', className, floating = true }: RobotProps) {
  ...
  return (
    ...
    >
      ...
      {/* тінь на підлозі */}
      <ellipse cx="140" cy="303" rx="86" ry="14" fill={`url(#${id('ground')})`} />
      ...
      <g filter={`url(#${id('soft')})`}>
        ...
        />
        {/* емблема на грудях */}
        <circle cx="140" cy="232" r="27" fill="#f1f5ea" stroke="#dde5d1" strokeWidth="1.5" />
        <path
      ...
      <g filter={`url(#${id('soft')})`}>
        ...
        {/* екран-обличчя */}
        <rect x="80" y="80" width="120" height="88" rx="36" fill={`url(#${id('screen')})`} />
        <rect
          x="80"
          y="80"
          width="120"
        ...
        {/* очі */}
        <g className="animate-blink" style={{ transformOrigin: '140px 116px', transformBox: 'view-box' }}>
          <ellipse cx="114" cy="116" rx="13" ry="15" fill={`url(#${id('eye')})`} />
          <ellipse cx="166" cy="116" rx="13" ry="15" fill={`url(#${id('eye')})`} />
          <ellipse cx="110" cy="110" rx="4" ry="5" fill="#f4ffe2" opacity="0.9" />
          <ellipse cx="162" cy="110" rx="4" ry="5" fill="#f4ffe2" opacity="0.9" />
        </g>
...
function Limb({
  ...
  const content = (
    <>
      ...
      />
      {/* заливка */}
      <path d={path} stroke={armFill} strokeWidth="18" strokeLinecap="round" fill="none" />

      {fingers && (
        <path d={fingers} stroke="#cfd5c6" strokeWidth="6" strokeLinecap="round" fill="none" />
      )}
