  ...
  return (
    <div className='animate-screen-in'>
      <div className='text-center'>
        ...
        <h1 className='mt-4 text-3xl sm:text-[2.5rem]'>
          {resultContent.ready}
        </h1>
        ...
        <div className='grid gap-7 md:grid-cols-[1fr_13rem] md:items-start md:gap-10'>
          <div>
            <div className='flex items-start gap-3'>
              ...
              <div>
                <h2 className='text-2xl leading-tight sm:text-[2rem]'>
                  {profile.name}
                </h2>
          ...
          <div className='order-first flex justify-center md:order-none md:pt-2'>
            <div className='grid size-44 place-items-center rounded-panel'>
              <ProfileEmblem variant={profile.emblem} className='size-44' />
            </div>
          </div>
        </div>
