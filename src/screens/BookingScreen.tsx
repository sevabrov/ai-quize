    ...
    <div className="animate-screen-in space-y-6">
      ...
      <Card padding="none" className="overflow-hidden">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-line px-5 py-4 sm:px-7">
          ...
          {booked && (
            <span className="flex items-center gap-1.5 rounded-full bg-leaf-100 px-3 py-1.5 text-xs font-semibold text-leaf-700">
      ...
      {/* ───── MIHI ───── */}
      <Card tone="wash" padding="md">
        <p className="text-[0.9375rem] leading-relaxed text-ink-soft">
          {bookingContent.mihiNote}
        </p>
      </Card>
